"""
Outputs a .csv where columns are cluster name and rows are genes with values being the squared difference in proportions
 over the absolute difference in proportion across all other clusters.
